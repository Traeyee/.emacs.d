...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet ssh smex smart-compile php-mode mmm-mode markdown-preview-eww markdown-mode ido-ubiquitous graphviz-dot-mode flycheck-ycmd company-ycmd cmake-mode auto-complete)))
 '(recentf-mode t)
 '(show-paren-mode t)
